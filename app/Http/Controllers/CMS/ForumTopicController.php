...
use App\Http\Requests\CMS\ForumTopicFormRequest;
...
class ForumTopicController extends Controller
{
    ...
    protected function createPost(ForumTopicFormRequest $request)
    {
        try {
            DB::beginTransaction();
            return redirect(route('forum-topics-management-page'));
        } catch (\Throwable $ex) {
            DB::rollback();
            logError($ex);
    ...
    protected function editPost(ForumTopicFormRequest $request)
    {
        try {
            DB::beginTransaction();
            return redirect(route('forum-topics-management-page'));

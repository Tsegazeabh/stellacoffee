<template>
    ...
    <template v-if="roastingMachines.length>0">
        <div v-for="item in roastingMachines" class="px-0 py-5 md:py-0 md:pl-3 flex flex-col flex-wrap items-start justify-between">
            ...
            <div class="text-right m-3">
                <inertia-link
                    :href="route('content-index-page', 'roasting-machine')"
                    type="button"
                    class="btn">

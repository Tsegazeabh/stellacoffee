<template>
    <slot name="header">
        <cms-header :collapse="collapse" :breakpoint="breakpoint" @toggleCollapse="toggleCollapse($event)"></cms-header>
    </slot>
    <main class="leading-relaxed bg-white w-full">
        <div class="flex w-full flex-wrap justify-start">
            <cms-side-navbar :collapse="collapse" :breakpoint="breakpoint" @toggleCollapse="toggleCollapse($event)"></cms-side-navbar>
...
<script>
    ...
    import CMSSideNavbar from "@components/CMSSideNavbar";

    ...
    <div class="flex flex-wrap w-full">
        <div class="breadcrump">
            <ul>
                ...
                <li>{{ _trans('label.shared.Cupping Procedures') }}</li>
            </ul>
        </div>
        <div class="flex flex-wrap w-full justify-end">
            <inertia-link type="button"
                          :href="route('cupping-procedure-creation-page')"
                          class="border text-gray-500 px-4 py-2 uppercase text-sm">
                <i class="fa fa-plus"></i>&nbsp;&nbsp;
                {{ _trans('label.shared.Create Cupping Procedure') }}
            </inertia-link>
        </div>
...
export default defineComponent({
    name: "cupping-process-management",
        ...
        return {
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    cellRendererParams: function (params) {
                        return {
                            editRoute: params.node.data != null && params.node.data.contentable != null ? route('cupping-procedure-editor-page', {id: params.node.data.contentable.id}) : ''
                        }
                    },
                    sortable: false
                },
        ...
        onGridReady: function (params) {
            ...
            let dataSource = {
                getRows: (params) => {
                    ...
                    axios.post(route('fetch-cupping-procedures'), this.searchModel).then(res => {
                        let result = res.data;

    ...
    <div class="flex flex-wrap w-full">
        <div class="breadcrump">
            <ul>
                ...
                <li>{{ _trans('label.shared.Duty Free Locations') }}</li>
            </ul>
        </div>
        <div class="flex flex-wrap w-full justify-end">
            <inertia-link type="button"
                          :href="route('duty-free-location-creation-page')"
                          class="border text-gray-500 px-4 py-2 uppercase text-sm">
                <i class="fa fa-plus"></i>&nbsp;&nbsp;
                {{ _trans('label.shared.Add Duty Free Location') }}
            </inertia-link>
        </div>
...
export default defineComponent({
    name: "duty-free-location-management",
    ...
    data() {
        return {
            ...
            columnDefs: [
                ...
                {
                    headerName: 'Country', field: 'country_id', valueGetter: function (params) {
                        return params != null && params.node.data != null ? params.node.data.contentable.country.display_name : 'N/A';
                    },
                    minWidth: 130,
                    autoHeight: true,
                    wrapText: true
                ...
                {
                    headerName: 'Airport', field: 'airport_name', valueGetter: function (params) {
                        return params != null && params.node.data != null ? params.node.data.contentable.airport_name : 'N/A';
                    },
                    minWidth: 130,
                    autoHeight: true,
                    wrapText: true
                ...
                {
                    headerName: 'Shop Address', field: 'shop_address', valueGetter: function (params) {
                        return params != null && params.node.data != null ? params.node.data.contentable.shop_address : 'N/A';
                    },
                    minWidth: 130,
                    autoHeight: true,
                    wrapText: true
                ...
                {
                    headerName: 'Longitude', field: 'longitude', valueGetter: function (params) {
                        return params != null && params.node.data != null ? params.node.data.contentable.longitude : 'N/A';
                    },
                    minWidth: 130,
                    autoHeight: true,
                    wrapText: true
                ...
                {
                    headerName: 'Latitude', field: 'latitude', valueGetter: function (params) {
                        return params != null && params.node.data != null ? params.node.data.contentable.latitude : 'N/A';
                    },
                    minWidth: 130,
                    autoHeight: true,
                    wrapText: true
                ...
                },
                {
                    ...
                    cellRendererParams: function (params) {
                        return {previewRoute: params.node.data != null ? route('duty-free-location-preview', params.node.data.id) : ''}
                    },
                    // colId: 'id',
                    sortable: false
                },
                ...
                },
                {
                    ...
                    cellRendererParams: function (params) {
                        return {
                            editRoute: params.node.data != null && params.node.data.contentable != null ? route('duty-free-location-editor-page', {id: params.node.data.contentable.id}) : ''
                        }
                    },
                    sortable: false
                },
        ...
        onGridReady: function (params) {
            ...
            let dataSource = {
                getRows: (params) => {
                    ...
                    axios.post(route('fetch-duty-free-locations'), this.searchModel).then(res => {
                        let result = res.data;

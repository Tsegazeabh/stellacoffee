    ...
    <div class="flex flex-wrap w-full">
        <div class="breadcrump">
            <ul>
                ...
                <li>{{ _trans('label.shared.Export Process') }}</li>
            </ul>
        </div>
        <div class="flex flex-wrap w-full justify-end">
            <inertia-link type="button"
                          :href="route('export-process-creation-page')"
                          class="border text-gray-500 px-4 py-2 uppercase text-sm">
                <i class="fa fa-plus"></i>&nbsp;&nbsp;
                {{ _trans('label.shared.Create Export Process') }}
            </inertia-link>
        </div>
...
export default defineComponent({
    name: "export-process-management",
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    cellRendererParams: function (params) {
                        return {previewRoute: params.node.data != null ? route('export-process-preview', params.node.data.id) : ''}
                    },
                    // colId: 'id',
                    sortable: false
                },
                ...
                },
                {
                    ...
                    cellRendererParams: function (params) {
                        return {
                            editRoute: params.node.data != null && params.node.data.contentable != null ? route('export-process-editor-page', {id: params.node.data.contentable.id}) : ''
                        }
                    },
                    sortable: false
                },
        ...
        onGridReady: function (params) {
            ...
            let dataSource = {
                getRows: (params) => {
                    ...
                    axios.post(route('fetch-export-process'), this.searchModel).then(res => {
                        let result = res.data;

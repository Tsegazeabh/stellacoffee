    ...
    <div class="flex flex-wrap w-full">
        <div class="breadcrump">
            <ul>
                ...
                <li>{{ _trans('label.shared.Factory Locations') }}</li>
            </ul>
        </div>
        <div class="flex flex-wrap w-full justify-end">
            <inertia-link type="button"
                          :href="route('factory-location-creation-page')"
                          class="border text-gray-500 px-4 py-2 uppercase text-sm">
                <i class="fa fa-plus"></i>&nbsp;&nbsp;
                {{ _trans('label.shared.Add Factory Location') }}
            </inertia-link>
        </div>
...
export default defineComponent({
    name: "factory-location-management",
    ...
    data() {
        return {
            ...
            columnDefs: [
                ...
                {
                    headerName: 'City', field: 'city_name', valueGetter: function (params) {
                        return params != null && params.node.data != null ? params.node.data.contentable.city.display_name : 'N/A';
                    },
                    minWidth: 200,
                },
                {
                ...
                {
                    headerName: 'Factory Address', field: 'factory_address', valueGetter: function (params) {
                        return params != null && params.node.data != null ? params.node.data.contentable.factory_address : 'N/A';
                    },
                    minWidth: 200,
                },
                {
                ...
                },
                {
                    ...
                    cellRendererParams: function (params) {
                        return {previewRoute: params.node.data != null ? route('factory-location-preview', params.node.data.id) : ''}
                    },
                    // colId: 'id',
                    sortable: false
                },
                ...
                },
                {
                    ...
                    cellRendererParams: function (params) {
                        return {
                            editRoute: params.node.data != null && params.node.data.contentable != null ? route('factory-location-editor-page', {id: params.node.data.contentable.id}) : ''
                        }
                    },
                    sortable: false
                },
        ...
        onGridReady: function (params) {
            ...
            let dataSource = {
                getRows: (params) => {
                    ...
                    axios.post(route('fetch-factory-locations'), this.searchModel).then(res => {
                        let result = res.data;

    ...
    <div class="flex flex-wrap w-full">
        <div class="breadcrump">
            <ul>
                ...
                <li>{{_trans('label.shared.Main Sliders')}}</li>
            </ul>
        </div>
        <div class="flex flex-wrap w-full justify-end">
            <inertia-link type="button" :href="route('main-slider-creation-page')"
                          class="border text-gray-500 px-4 py-2 uppercase text-sm">
                <i class="fa fa-plus"></i>&nbsp;&nbsp;{{_trans('label.shared.Create Main Slider')}}
            </inertia-link>
        </div>
    ...
    export default {
        ...
        data() {
            return {
                ...
                columnDefs: [
                    {
                        headerName: 'Slider Name', field: 'title', valueGetter: function (params) {
                    ...
                    },
                    {
                        ...
                        cellRendererParams: function (params) {
                            return {previewRoute: params.node.data != null ? route('preview-main-slider', params.node.data.id) : ''}
                        },
                        // colId: 'id',
                        sortable: false
                    },
                    ...
                    },
                    {
                        ...
                        cellRendererParams: function (params) {
                            return {editRoute: params.node.data != null && params.node.data.contentable != null ? route('main-slider-editor-page', params.node.data.contentable.id) : ''}
                        },
                        sortable: false
                    },
                    {
            ...
            onGridReady: function (params) {
                ...
                let dataSource = {
                    getRows: (params) => {
                        ...
                        axios.post(route('fetch-main-slider'), this.searchModel).then(res => {
                            let result = res.data;

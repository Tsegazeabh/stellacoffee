    ...
    <div class="flex flex-wrap w-full">
        <div class="breadcrump">
            <ul>
                ...
                <li>{{_trans('menu.News')}}</li>
            </ul>
        </div>
        <div class="flex flex-wrap w-full justify-end">
            <inertia-link type="button" :href="route('news-creation-page')"
                          class="border text-gray-500 px-4 py-2 uppercase text-sm">
                <i class="fa fa-plus"></i>&nbsp;&nbsp;{{_trans('action.Create News')}}
            </inertia-link>
        </div>
                ...
                columnDefs: [
                    ...
                    },
                    {
                        headerName: 'Video Link', field: 'video_link', valueGetter: function (params) {
                            return params != null && params.node.data != null && params.node.data.contentable != null ? params.node.data.contentable.video_link : 'N/A';
                        },
                        // colId: 'params',
                        minWidth: 300,
                        autoHeight: true,
                    ...
                    },
                    {
                        ...
                        cellRendererParams: function (params) {
                            return {previewRoute: params.node.data != null ? route('preview-news', params.node.data.id) : ''}
                        },
                        // colId: 'id',
                        sortable: false
                    },
                    ...
                    },
                    {
                        ...
                        cellRendererParams: function (params) {
                            return {editRoute: params.node.data != null && params.node.data.contentable != null ? route('news-editor-page', params.node.data.contentable.id) : ''}
                        },
                        sortable: false
                    },
            ...
            onGridReady: function (params) {
                ...
                let dataSource = {
                    getRows: (params) => {
                        ...
                        axios.post(route('fetch-news'), this.searchModel).then(res => {
                            let result = res.data;

    ...
    <div class="flex flex-wrap w-full">
        <div class="breadcrump">
            <ul>
                ...
                <li>{{_trans('label.shared.Partners')}}</li>
            </ul>
        </div>
        <div class="flex flex-wrap w-full justify-end">
            <inertia-link type="button" :href="route('partner-creation-page')"
                          class="border text-gray-500 px-4 py-2 uppercase text-sm">
                <i class="fa fa-plus"></i>&nbsp;&nbsp;{{_trans('label.shared.Create Partner')}}
            </inertia-link>
        </div>
    ...
    export default {
        ...
        data() {
            return {
                ...
                columnDefs: [
                    {
                        headerName: 'Partner Name', field: 'title', valueGetter: function (params) {
                    ...
                    {
                        headerName: 'Official Link', field: 'link', valueGetter: function (params) {
                            return params != null && params.node.data != null && params.node.data.tags != null ? params.node.data.contentable.link : 'N/A';
                        },
                        // colId: 'params',
                        autoHeight: true,
                        sortable: false
                    ...
                    },
                    {
                        ...
                        cellRendererParams: function (params) {
                            return {previewRoute: params.node.data != null ? route('preview-partner', params.node.data.id) : ''}
                        },
                        // colId: 'id',
                        sortable: false
                    },
                    ...
                    },
                    {
                        ...
                        cellRendererParams: function (params) {
                            return {editRoute: params.node.data != null && params.node.data.contentable != null ? route('partner-editor-page', params.node.data.contentable.id) : ''}
                        },
                        sortable: false
                    },
                    {
            ...
            onGridReady: function (params) {
                ...
                let dataSource = {
                    getRows: (params) => {
                        ...
                        axios.post(route('fetch-partner'), this.searchModel).then(res => {
                            let result = res.data;

<template>
    <div class="breadcrump">
        <ul>
            ...
            <li>
                <inertia-link :href="route('roasting-process-management-page')">
                    {{ _trans('label.shared.Roasting Process') }}
                </inertia-link>
            </li>
            <li>{{ _trans('action.create') }}</li>
        </ul>
    </div>
    <RoastingProcessForm :roasting_process="roasting_process"
                         :error-message="errorMessage"
                         :success-message="successMessage"
                         :errors="errors"
                         :method="'post'"
                         :url="route('post-roasting-process')">
    </RoastingProcessForm>
</template>
<script>
...
export default defineComponent({
    name: "CreateRoastingProcess",
    components: {RoastingProcessForm},

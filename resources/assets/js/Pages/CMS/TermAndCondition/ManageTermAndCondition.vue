    ...
    <div class="flex flex-wrap w-full">
        <div class="breadcrump">
            <ul>
                ...
                <li>{{_trans('label.shared.Terms and Conditions')}}</li>
            </ul>
        </div>
        <div class="flex flex-wrap w-full justify-end">
            <inertia-link type="button" :href="route('term-and-condition-creation-page')"
                          class="border text-gray-500 px-4 py-2 uppercase text-sm">
                <i class="fa fa-plus"></i>&nbsp;&nbsp;{{_trans('label.shared.Create Terms and Conditions')}}
            </inertia-link>
        </div>
...
<script>
    ...
    export default {
        name: "manage-term-and-condition",
        components: {
            Button,
        ...
        data() {
            return {
                ...
                columnDefs: [
                    {
                        headerName: 'Title',
                        field: 'title', valueGetter: function (params) {
                    ...
                    },
                    {
                        ...
                        cellRendererParams: function (params) {
                            return {previewRoute: params.node.data != null ? route('preview-term-and-condition', params.node.data.id) : ''}
                        },
                        // colId: 'id',
                        sortable: false
                    },
                    ...
                    },
                    {
                        ...
                        cellRendererParams: function (params) {
                            return {editRoute: params.node.data != null && params.node.data.contentable != null ? route('term-and-condition-editor-page', params.node.data.contentable.id) : ''}
                        },
                        sortable: false
                    },
                    {
            ...
            onGridReady: function (params) {
                ...
                let dataSource = {
                    getRows: (params) => {
                        ...
                        axios.post(route('fetch-term-and-condition'), this.searchModel).then(res => {
                            let result = res.data;

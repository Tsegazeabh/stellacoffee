<template>
    <div class="breadcrump">
        <ul>
            ...
            <li>
                <inertia-link :href="route('testimonials-management-page')">
                    {{ _trans('label.shared.Customer Testimonials') }}
                </inertia-link>
            </li>
            <li>{{ _trans('action.edit') }}</li>
        </ul>
    </div>
    <testimonial-form :customer_testimonial="customer_testimonial"
                      :errors="errors"
                      :method="'PUT'"
                      :url="route('update-testimonial', customer_testimonial.id)">
    </testimonial-form>
</template>

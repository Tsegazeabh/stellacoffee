    ...
    <div class="flex flex-wrap w-full">
        <div class="breadcrump">
            <ul>
                ...
                <li>{{ _trans('label.shared.Customer Testimonials') }}</li>
            </ul>
        </div>
        <div class="flex flex-wrap w-full justify-end">
            <inertia-link type="button"
                          :href="route('testimonial-creation-page')"
                          class="border text-gray-500 px-4 py-2 uppercase text-sm">
                <i class="fa fa-plus"></i>&nbsp;&nbsp;
                {{ _trans('label.shared.Create Customer Testimonial') }}
            </inertia-link>
        </div>
...
export default defineComponent({
    ...
    data() {
        return {
            ...
            columnDefs: [
                {
                    headerName: 'Name', field: 'testimonial_name', valueGetter: function (params) {
                        return params != null && params.node.data != null && params.node.data.contentable != null ? params.node.data.contentable.testimonial_name : 'N/A';
                    },
                    minWidth: 200,
                    autoHeight: true,
                    wrapText: true
                ...
                {
                    headerName: 'Organization', field: 'testimonial_organization', valueGetter: function (params) {
                        return params != null && params.node.data != null && params.node.data.contentable != null ? params.node.data.contentable.testimonial_organization : 'N/A';
                    },
                    minWidth: 200,
                    autoHeight: true,
                    wrapText: true
                ...
                {
                    headerName: 'Position', field: 'testimonial_position', valueGetter: function (params) {
                        return params != null && params.node.data != null && params.node.data.contentable != null ? params.node.data.contentable.testimonial_position : 'N/A';
                    },
                    minWidth: 200,
                    autoHeight: true,
                    wrapText: true
                ...
                {
                    headerName: 'Message', field: 'testimonial_message', valueGetter: function (params) {
                ...
                {
                    headerName: 'Testimonial Date', field: 'testimonial_date', valueGetter: function (params) {
                        return params != null && params.node.data != null && params.node.data.contentable != null ?
                            moment(params.node.data.contentable.testimonial_date, "YYYY-MM-DD").format("YYYY-MM-DD"): 'N/A';
                    },
                    minWidth: 200,
                    autoHeight: true,
                    wrapText: true
                ...
                },
                {
                    ...
                    cellRendererParams: function (params) {
                        return {previewRoute: params.node.data != null ? route('testimonial-preview', params.node.data.id) : ''}
                    },
                    sortable: false
                },
                {
                ...
                },
                {
                    ...
                    cellRendererParams: function (params) {
                        return {
                            editRoute: params.node.data != null && params.node.data.contentable != null ? route('testimonial-editor-page', {id: params.node.data.contentable.id}) : ''
                        }
                    },
                    sortable: false
                },
        ...
        onGridReady: function (params) {
            ...
            let dataSource = {
                getRows: (params) => {
                    ...
                    axios.post(route('fetch-testimonials'), this.searchModel).then(res => {
                        let result = res.data;

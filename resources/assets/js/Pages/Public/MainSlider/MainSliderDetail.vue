...
<!--            <meta name="twitter:image" :content="content.contentable.first_image['src']">-->
        ...
        <div class="flex flex-wrap w-full my-5">
            <img class="object-scale-down" :srcset="content.contentable.src_sets" />
        </div>

        <div class="flex flex-wrap justify-end items-center content-info text-gray-600 text-base py-3 my-5 text-right">

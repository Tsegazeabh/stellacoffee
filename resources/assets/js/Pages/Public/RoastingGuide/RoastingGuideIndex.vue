<template>
    ...
    <div class="w-full">
        <div class="flex flex-wrap">
            <div v-for="guide in result" class="card-container flex flex-col md:flex-row w-full">
                <div class="grid grid-cols-3 justify-center items-center border-b my-4 pb-5">
                    <div class="col-span-1">
                        <img :src="guide.image" class="object-fill"/>
                    </div>
                    <div class="col-span-2 px-10 flex flex-col justify-center items-start">
                        <h2 class="text-stella text-xl my-3">{{ guide.name }}</h2>
                        <p>{{ guide.description }}</p>
                        <span class="text-stella text-xl my-3">{{ guide.price }}</span>
                    </div>
                </div>
            </div>
        </div>
                ...
                result: [
                    {
                        ...
                        description: 'Lavazza Crema e Gusto Espresso is a special guide of Robusta and Arabica beans.',
                        price: '$14.00'
                    },
                    {

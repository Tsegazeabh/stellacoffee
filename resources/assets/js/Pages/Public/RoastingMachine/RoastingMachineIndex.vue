<template>
    ...
    <div class="w-full">
        <div v-if="result && result.total>0" class="flex flex-wrap">
            <div v-for="(machine,index) in result.data" class="card-container flex flex-col md:flex-row w-full">
                    ...
                    <div class="col-span-2 px-10 flex flex-col justify-center items-start">
                        ...
                        <div class="px-4 justify-center">
                            <template v-if="machine.contentable.video_link">
                                <video-embed :src="machine.contentable.video_link"></video-embed>
                            </template>
...
<script>
    ...
    export default defineComponent({
        ...
        props: {
            ...
            sub_menu_name:'menu.Roasting Machine',
        },

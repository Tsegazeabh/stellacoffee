        ...
        <div class="flex flex-wrap">
            <div class="flex flex-wrap justify-center items-center w-full pt-5 pb-16">
                <h1 class="text-center uppercase font-black text-2xl w-full md:w-1/2 mb-5">
                    {{ _trans('label.shared.Brief Historical Review Of Ethiopian Electric Utility') }}
                </h1>
                        ...
                        <div class="detail">
                            ...
                            <div class="flex flex-wrap w-full justify-end items-end">
                                <inertia-link :href="content.url"
                                              class="uppercase font-semibold p-2 rounded-sm hover:bg-green-100 hover:border-green-300">
